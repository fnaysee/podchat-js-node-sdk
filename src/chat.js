...
function Chat(params) {
    ...
    var init = function () {
         ...
         * @return {undefined}
         */
        httpRequest = async function (params, callback) {
            var url = params.url,
            ...
            if (isNode && Request) {
                ...
                if (params.method == 'POST' && data) {
                    if (data.hasOwnProperty('image') || data.hasOwnProperty('file')) {
                        ...
                        // var r = httpRequestObject[eval('fileUploadUniqueId')] = fetch(url,{
                        ...
                        .then(res => res.body.on('readable', () => {
                            ...
                            while (null !== (chunk = res.body.read())) {
                                ...
                                chatEvents.fireEvent('fileDownloadEvents', {
                                    ...
                                    uniqueId: fileUniqueId,
                                    state: 'DOWNLOADING',
                                    progress: Math.round((receivedLength / res.contentLength) * 100),
                                    fileInfo: {
                                        fileName: originalFileName,
                                        fileSize: fileSize
                                    },
        ...
        objectDeepMerger = function (...params) {
            var target = {};
